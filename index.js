// will crate a  emty username variable
...
let userQuestion ='Your secret question ?'
/*Write a console.log() for the userQuestion, stating what was asked. You can include the user’s name in the console.log() statement, if you wi */
console.log(`${userName}, you want to know : ${userQuestion}`);
...
/*Create one more variable named eightBall, and set it equal to an empty string. We will save a value to this variable in the next steps, depending on the value of randomNumb */
let eightBall = '';
/* 
...
/* Write a console.log() to print the Magic Eight Ball’s answer, the value of the eightBall variabl */
